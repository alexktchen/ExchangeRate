...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        navigationBar.backgroundColor = CustomColors.lightRedColor
    ...
    func application(application: UIApplication, openURL url: NSURL, sourceApplication: String?, annotation: AnyObject) -> Bool {
        ...
        if url.scheme == "simpleTimer" {
            if url.host == "finished" {
                ...
                let view = storyboard.instantiateViewControllerWithIdentifier("TodayView")
    ...
    func changeStatusBarColor() {
        ...
        let label = UILabel(frame: CGRectMake(0, 0, self.window!.frame.size.width, 20))
        label.backgroundColor = CustomColors.lightRedColor
        self.window?.rootViewController?.view.addSubview(label)
        self.window?.backgroundColor = CustomColors.lightRedColor
    }
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "Alex-Chen.ExchangeRate" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("ExchangeRate", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("ExchangeRate.sqlite")
